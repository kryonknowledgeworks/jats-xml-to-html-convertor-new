...
import org.kjms.xmlparser.commontag.ObjectId;
import org.kjms.xmlparser.commontag.TableWrapper;
import org.kjms.xmlparser.commontag.TableWrapperGroup;
    ...
    public String getElement() {
        ...
        for (int i = 0; i < node.getChildNodes().getLength(); i++) {
            ...
            if (nodeName.equalsIgnoreCase(Element.OBJECT_ID)) {
                ...
                if (nodeName.equalsIgnoreCase(Element.BOXED_TEXT)) {
