...
public class Roman implements Tag {
    private final Node node;

    public Roman(Node node) {
        this.node = node;
    }
    ...
    public String getElement() {
        ...
        for (int i = 0; i < node.getChildNodes().getLength(); i++) {
            ...
            if (nodeName.equalsIgnoreCase(Element.TEXT)) {
                stringBuilder.append(TagUtils.addSpanTag(node.getTextContent(), "font-family: 'Times New Roman', Times, serif;"));
